...
public class OutputView {
    ...
    private static final String PRINT_TOTAL_SCORE_FORMAT = "\n%s";
    private static final String PRINT_TOTAL_RESULT_FORMAT = "\n## 최종 승패\n%s";
    ...
    public static void printTotalScore(String totalScore) {
        System.out.printf(PRINT_TOTAL_SCORE_FORMAT, totalScore);
    }

    public static void printTotalResult(String totalResult) {
        System.out.printf(PRINT_TOTAL_RESULT_FORMAT, totalResult);
    }
}
